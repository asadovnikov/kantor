...
export const CookiesPolicy = () => (
	<Container className='privacy-container' maxWidth='md'>
		<Paper elevation={3}>
			<Box className='preview-agreement' p={[2, 3, 8]}>
				...
				<ul>
					...
					<li>
						...
						on behalf of which such individual is accessing or using the Website, as applicable.
					</li>
					<li>
