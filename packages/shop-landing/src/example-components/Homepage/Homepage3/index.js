...
import abstract from './abstract-downloading.png';
import abstract2 from './abstract-logged-out.png';
              ...
              <div className="mb-4">
                ...
                <Grid item md={11} lg={10} className="mx-auto">
                  <p className="text-white opacity-6 mt-3 mb-4 font-size-xxl">
                    Use your debit or credit card or choose from a diverse set
                    of worldwide deposit options.
                  </p>
                </Grid>
              </div>
