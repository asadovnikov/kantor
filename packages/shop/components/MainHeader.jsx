						...
						<Container className='z-over shadow-container-content-5'>
							<Grid container spacing={6} className='py-5'>
								<Grid item lg={6}>
									<div className='pt-3 text-white pt-xl-5 pr-0 pr-xl-5'>
										...
										<p className='font-size-xl py-3 text-white-50'>
											Easy to customize application inspired by the cryptocurrency products niche. Start working on your
											product today with this amazing, clean and feature-packed niche template.
										</p>
										<div className='pt-3'>
											<Button
												component='a'
												...
												<span className='btn-wrapper--label'>Dashboard Overview</span>
								...
								<Grid item lg={6} className='d-flex align-items-center'>
									<img src={illustration1} alt='...' className='m-5 m-lg-0 img-fit-container' />
								</Grid>
							</Grid>
									...
									<Card className='shadow-xxl card-box-hover-rise mb-5'>
										<div className='d-flex align-items-center p-4'>
											<div className='d-50 text-white d-flex align-items-center justify-content-center rounded-pill bg-warning shadow-xxl mr-3'>
												<FontAwesomeIcon icon={['fab', 'bitcoin']} className='font-size-xxl' />
											</div>
											<div>
												<div className='font-weight-bold text-black'>Bitcoin</div>
												<div className='text-dark opacity-7'>24h Vol.: $239.454</div>
											</div>
										</div>
										<div className='px-4'>
											...
											<div className='d-flex mt-1 align-items-center'>
												...
												<div className='font-size-sm font-weight-bold text-black-50 pl-2'>Last 24h</div>
											</div>
										</div>
										<div className='mt-4'>
											<Chart options={chartHomepage1AOptions} series={chartHomepage1AData} type='area' height={150} />
										</div>
									</Card>
								</Grid>
								<Grid item lg={4}>
									<Card className='shadow-xxl card-box-hover-rise mb-5'>
										<div className='d-flex align-items-center p-4'>
											<div className='d-50 text-white d-flex align-items-center justify-content-center rounded-pill bg-first shadow-xxl mr-3'>
												<FontAwesomeIcon icon={['fab', 'ethereum']} className='font-size-xxl' />
											</div>
											<div>
												<div className='font-weight-bold text-black'>Ethereum</div>
												<div className='text-dark opacity-7'>24h Vol.: $182.295</div>
											</div>
										</div>
										<div className='px-4'>
											<div className='text-black py-2 font-size-xxl d-flex align-items-center'>
										...
										<div className='mt-4'>
											<Chart options={chartHomepage1AOptions} series={chartHomepage1CData} type='area' height={150} />
										</div>
									</Card>
								</Grid>
								<Grid item lg={4}>
									<Card className='shadow-xxl card-box-hover-rise mb-5'>
										<div className='d-flex align-items-center p-4'>
											<div className='d-50 text-white d-flex align-items-center justify-content-center rounded-pill bg-success shadow-xxl mr-3'>
												<FontAwesomeIcon icon={['fas', 'dollar-sign']} className='font-size-xxl' />
											</div>
											<div>
												<div className='font-weight-bold text-black'>USDT</div>
												<div className='text-dark opacity-7'>24h Vol.: $23.453</div>
											</div>
										</div>
										<div className='px-4'>
											<div className='text-black py-2 font-size-xxl d-flex align-items-center'>
										...
										<div className='mt-4'>
											<Chart options={chartHomepage1BOptions} series={chartHomepage1BData} type='area' height={150} />
										</div>
									</Card>
								</Grid>
							</Grid>
