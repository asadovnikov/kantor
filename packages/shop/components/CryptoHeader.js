		...
		<>
			<div className='header-top-section py-3'>
				<Container className='d-flex header-nav-menu justify-content-between align-items-center navbar-dark'>
						...
						<li>
							...
							<div className='submenu-dropdown submenu-dropdown--sm'>
								<div className='shadow-sm-dark bg-white rounded-sm'>
									<List component='div' className='nav-pills nav-neutral-primary flex-column p-2'>
										<ListItem
											button
											href='#/'
											onClick={(e) => e.preventDefault()}
					...
					<ul className='d-flex'>
						<li className='mr-0'>
							<a className='rounded-sm py-1 px-3 font-size-xs text-uppercase' to='/PageLoginCover'>
								Members Login
							</a>
						</li>
					</ul>
				...
				<div className='bg-white-10 p-2 header-nav-wrapper header-nav-wrapper-xl rounded px-4 navbar-dark'>
					<div className='app-nav-logo'>
						<a
							...
							<div className='app-nav-logo--icon shadow-second-sm bg-secondary border-0'>
								<img alt='Bamburgh React Crypto Application with Material-UI PRO' src={'./assets/images/react.svg'} />
							</div>
					...
					<div className='header-nav-menu d-none d-lg-block'>
						<ul className='d-flex nav nav-neutral-first justify-content-center'>
							<li>
								<a to='/Overview' className='font-weight-bold rounded-sm text-white px-3'>
									Overview
								</a>
							</li>
							<li>
								<a to='/BuySell' className='font-weight-bold rounded-sm text-white px-3'>
									Buy/Sell
								</a>
							</li>
							<li>
								<a to='/Settings' className='font-weight-bold rounded-sm text-white px-3'>
									Settings
								</a>
							</li>
							<li>
					...
					<div className='d-flex d-lg-none'>
						<Collapse in={collapse} className='nav-collapsed-wrapper shadow-sm-dark navbar-collapse'>
							<div className='nav-inner-wrapper'>
								...
								<div className='p-3'>
									...
									<List component='div' className='nav-pills nav-neutral-primary nav-pills-rounded flex-column'>
										<ListItem button component='a' to='/Overview' className='px-4 d-flex align-items-center'>
											<span>Overview</span>
											<FontAwesomeIcon icon={['fas', 'angle-right']} className='opacity-6 ml-auto' />
										</ListItem>
										<ListItem button component='a' to='/BuySell' className='px-4 d-flex align-items-center'>
											<span>Buy/Sell</span>
											<FontAwesomeIcon icon={['fas', 'angle-right']} className='opacity-6 ml-auto' />
										</ListItem>
										<ListItem button component='a' to='/Settings' className='px-4 d-flex align-items-center'>
											<span>Settings</span>
											<FontAwesomeIcon icon={['fas', 'angle-right']} className='opacity-6 ml-auto' />
										</ListItem>
									</List>
