			...
			<Menu
				...
				<div className='dropdown-menu-xl overflow-hidden p-0'>
					<div className='d-flex p-4'>
						...
						<div>
							<h6 className='font-weight-bold mb-1 text-black'>Satoshi Nakamoto</h6>
					...
					<div className='bg-secondary d-flex align-items-center flex-column py-4'>
						...
						<small className='text-center font-weight-bold opacity-6 text-uppercase'>Total balance</small>
					</div>
					<div className='divider' />
