...
exports.updateCustomerLimits = async (event) => {
  ...
  customer.FiatDailyAmount = customer.FiatDailyAmount + transaction.FiatAmount;
  customer.FiatMonthlyAmount = customer.FiatMonthlyAmount + transaction.FiatAmount;

  //TODO: refactor
  if (customer.FiatDailyAmount < 1000 && customer.FiatMonthlyAmount < 20000) {
    //TODO: Handle situation with just created account
    customer.Tier = 'low';
  }
  else if (customer.FiatDailyAmount < 5000 && customer.FiatMonthlyAmount < 100000) {
